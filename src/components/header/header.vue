			...
			<div v-show="detailShow" class="detail">
				<div class="detail-wrapper clearfix">
					<div class="detail-main">
						...
						<div class="title">
							<line-title :textTitle="lineTitleText_1" :lineColor="lineColor"></line-title>
						</div>
						...
						<div class="title">
							<line-title :textTitle="lineTitleText_2" :lineColor="lineColor"></line-title>
						</div>
						<div class="bulletin">
...
<script type="ecmascript-6">
	...
	export default {
		...
		data() {
			return {
				detailShow: false,
				lineColor: 'border-bottom: 1px solid rgba(255, 255, 255, .2);',
				lineTitleText_1: '优惠信息',
				lineTitleText_2: '商家公告'
			};
		},
		methods: {
			showDetail() {
