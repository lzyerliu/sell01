<template>
	<div class="goods">
		...
		<div class="foods-wrapper" ref="foodsWrapper">
			<ul>
				<li v-for="(item,index_1) in goods" :key="index_1" class="food-list food-list-hook">
					<h1 class="title">{{item.name}}</h1>
					<ul>
						<li v-for="(food,index_2) in item.foods" :key="index_2" class="food-item" @click="selectFood(food,$event)">
							<div class="icon">
							...
							<div class="content">
								...
								<div class="cart-control-wrapper">
									<cart-control :food="food" v-on:cart-add="cartAddP"></cart-control>
								</div>
							</div>
						</li>
					</ul>
