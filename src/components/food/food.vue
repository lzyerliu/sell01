	...
	<transition name="move">
		<div v-show="showFlag" class="food" ref="food">
			<div class="food-content">
				...
				<split v-show="food.ratings && food.ratings.length>0"></split>
				<div class="rating">
					<h1 class="title">商品评价</h1>
					<rating-select :selectType="selectType" :onlyContent="onlyContent" :desc="desc" :ratings="food.ratings" v-on:rating-type-select="ratingTypeSelect" v-on:content-toggle="contentToggle"></rating-select>
